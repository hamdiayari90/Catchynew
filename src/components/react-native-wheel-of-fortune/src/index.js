...
class WheelOfFortune extends Component {
  ...
  _onPress = () => {
    ...
    Animated.timing(this._angle, {
      ...
      // console.log('========================================================================closeModal', this.props.closeModal)
      //console.log('winnerIndex', winnerIndex);
      this.props.getWinner(this._wheelPaths[winnerIndex].value, winnerIndex);
      // if (this.state.finished) {this.props.closeModal()}
      //if (this.state.finished) {this.props.showModal()}
  ...
  _textRender = (x, y, number, i) => (
    <Text
      ...
      <ImageRender x={x} y={y} i={i} options={this.props.options}></ImageRender>
