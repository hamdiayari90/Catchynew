...
const Services1 = () => {
  ...
  const handleNavigation = () => {
    navigation.navigate('RechargeMobile'); // 'RechargeMobile' should be the name of the screen in your navigator
};
  return (
    ...
    <View style={styles.services}>
      ...
      >
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/recharge/cemrekartworksfanta-16.png")}
        />
          ...
          <View style={styles.frameGroup}>
            ...
            <View style={[styles.iconsGroup, styles.iconsParentFlexBox]}>
              ...
              <View style={[styles.textContainer, styles.iconsParentFlexBox]}>
                <Text style={styles.textTypo}>Jusqu’au 20 Septembre</Text>
              </View>
            </View>
          </View>
        </View>
